...
public class SeckillServiceImpl implements SeckillService{
    ...
    @Override
    @Transactional
    public SeckillResponse executeSeckill(long seckillId, BigDecimal money, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillCloseException {
        ...
        try {
            ...
            if (insertCount <= 0) {
                ...
                if (updateCount <= 0) {
                    ...
                    return new SeckillResponse(seckillId, SeckillStatEnum.SUCCESS, seckillOrder);
                }
            }
