...
public class SeckillResponse {
    ...
    public SeckillResponse(Long seckillId, SeckillStatEnum seckillStatEnum, SeckillOrder seckillOrder) {
    ...
    public SeckillResponse(Long seckillId, SeckillStatEnum seckillStatEnum) {
        this.seckillId = seckillId;
        this.state = seckillStatEnum.getState();
        this.stateInfo = seckillStatEnum.getStateInfo();
    }
